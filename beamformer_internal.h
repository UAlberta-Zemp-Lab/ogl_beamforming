...
typedef enum {
	VulkanImageUsageFlag_Sampling            = 1 << 0,
	/* NOTE: uses:
	 * 1. image-image copy operations
	 * 2. transfer to swap chain framebuffer for display
	 */
	VulkanImageUsageFlag_TransferSource      = 1 << 1,
	VulkanImageUsageFlag_TransferDestination = 1 << 2,
...
DEBUG_IMPORT void vk_image_allocate(GPUImage *, u32 width, u32 height, u32 mips, u32 samples, VulkanImageUsage usage, VulkanImageUsageFlags flags, OSHandle *export);
